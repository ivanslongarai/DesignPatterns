...
type
  ...
  public
    ...
    class procedure WriteLog(AText: string); overload;
    class procedure WriteLog(AString: TString); overload;
...
class procedure TUtilsSingleton.WriteLog(AString: TString);
begin
  WriteLog(AString.Str);
  FreeAndNil(AString);
end;
